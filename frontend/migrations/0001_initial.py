...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='group',
            name='kind',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='frontend.GroupKind'),
        ),
        migrations.CreateModel(
            name='Coding',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='coding',
            constraint=models.UniqueConstraint(fields=('system', 'code'), name='system_and_code_unique_together'),
        ),
    ]
